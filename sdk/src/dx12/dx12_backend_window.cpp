...
namespace d3d12
{
	namespace window
	{
		...
		RenderWindow create_window(GraphicsDevice, uint64_t hInstance, uint32_t width, uint32_t height, const char* windowName)
		{
			...
			RegisterWindowClass(hInst, "TSNCWindow");
		...
		void set_cursor_visibility(RenderWindow, bool state)
		{
			ShowCursor(state);
		}
