...
namespace d3d12
{
    ...
    namespace window
    {
        ...
        RenderWindow create_window(GraphicsDevice device, uint64_t hInstance, uint32_t width, uint32_t height, const char* windowName = "sdk");
...
#pragma region Profiling scopes
